...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "R Production Lighting",
                description: "Support All Event"
            },
            {
                title: "Rizky Carwash",
                description: "Cuci Karpet, Sepeda Motor, Mobil, Truck, dll"
            },
            {
                title: "Rizky Production Music",
                description: "Harmoni music untuk event anda"
            },
            {
                title: "Rizky Production Photoshoot",
                description: "Abadikan momen penting anda"
            },
            {
